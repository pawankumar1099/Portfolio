    ...
    const socialIcon = [
        {
            ...
            href: "https://linkedin.com/in/pawankumar9aa",
            icon: "LinkedIn"
        },
        {
            img: "/images/icon/github-icon.svg",
            href: "https://github.com/pawankumar1099",
            icon: "GitHub"
        },
        {
            img: "/images/icon/gmail-icon.svg",
            href: "mailto:pawankumar9aa@gmail.com",
            icon: "Gmail"
        },
    ];
    return (
                    ...
                    <div className="border-x border-primary/10">
                        <div className="relative flex flex-col xs:flex-row items-center xs:items-start justify-center xs:justify-between max-w-3xl mx-auto gap-10 xs:gap-3 px-4 sm:px-7 pt-22 pb-8 sm:pb-12">
                            ...
                            <div className="flex flex-col gap-2 sm:gap-3 items-center text-center xs:items-start">
                                <h1>Pawan Kumar</h1>
                                <p className="text-violet-700 font-normal">Full Stack Developer & Frontend Enthusiast</p>
                                <div className="flex items-center gap-2">
                                    <Image src={"/images/icon/map-icon.svg"} alt="map-icon" width={20} height={20} />
                                    <p className="text-primary">Mathura, India</p>
                                </div>
                            </div>
                                    ...
                                    >
                                        <span className="flex items-center gap-3 bg-primary hover:bg-[linear-gradient(96.09deg,_#9282F8_12.17%,_#F3CA4D_90.71%)] py-2.5 px-5 rounded-full">
                                            <Image
                                                ...
                                                height={14}
                                            />
                                            <span className="text-sm sm:text-base font-semibold text-white">Hire Me</span>
                                        </span>
                                    </Link>
                                </Button>
                            </div>
