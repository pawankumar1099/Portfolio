                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 border-t border-primary/10">
                        {featureWork?.map((value: any, index: number) => {
                            ...
                            return (
                                ...
                                >
                                    <Link href={value?.href || "/"} target="_blank" className="overflow-hidden">
                                        <Image
                                            src={value?.image}
                                            alt="Image"
                                            width={490}
                                            height={300}
                                            className="w-full h-full group-hover:scale-105 transition-all duration-300 ease-in-out rounded-sm"
                                        />
                                    </Link>
                                    <div className="flex flex-col gap-1 sm:gap-2 px-2">
                                        <Link href={value?.href || "/"} target="_blank"><h4>{value?.title}</h4></Link>
                                        <div className="flex">
